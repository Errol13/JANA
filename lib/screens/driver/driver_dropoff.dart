...
class DdropoffPage extends StatefulWidget {
  const DdropoffPage({Key? key}) : super(key: key);

  @override
  _DdropoffPageState createState() => _DdropoffPageState();
}

class _DdropoffPageState extends State<DdropoffPage> {
  bool positive = false;
  @override
                          ...
                          Expanded(
                            child: Padding(
                              padding: EdgeInsets.symmetric(
                                  horizontal: 15), // Add padding horizontally
                              child: CustomButton(
                                text: 'Drop Off',
                                color: Color(0xFFFA5FAE),
                                width: 140,
